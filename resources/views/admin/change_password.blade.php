                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="password" name="old_password" class="form-control @error('old_password') is-invalid @enderror" id="current_password" value="">
                                                @error('old_password')
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="password" name="new_password" class="form-control @error('new_password') is-invalid @enderror" id="new_password" value="">
                                                @error('new_password')
                                                 <span class="text-danger"> {{ $message }} </span>
                                                @enderror
                                            </div>
